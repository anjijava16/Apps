...
public class RulesManager {
	public static final void main(String[] args) {
		try {
			...
			ValidationControl control = entitymanager.find(ValidationControl.class, 1);
	...
	private static KnowledgeBase readKnowledgeBase() throws Exception {
		...
		kbuilder.add(ResourceFactory.newClassPathResource("validations-001-099.drl"),
				ResourceType.DRL);
		kbuilder.add(ResourceFactory.newClassPathResource("validations-100-199.drl"), ResourceType.DRL);
