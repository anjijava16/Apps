...
<script src="http://code.jquery.com/ui/1.10.0/jquery-ui.js"></script>
	...
	<style>
		...
		.header { top: 0px; height: 80px; border-bottom: 1px #ccc solid;background-color: #FFC0CB; }
		.footer { clear: both;  overflow:hidden; border-top: 1px #ccc solid; padding: 10px 0px 0px 0px; background-color: #00A5FF}
		...
		.link {padding: 20px 76px 20px 30px; background-color: #f4f4f4; border: 1px solid #ccc; font-family: verdana; width: 400px; margin: 0 auto;  margin-top: 40px; margin-bottom: 40px;}
...
<body>
<div class="header"><h1>Employee Management Screen</h1></div>